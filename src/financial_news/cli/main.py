...
def test(demo, duration):
    ...
    try:
        ...
        console.print("💡 Make sure you're in the project directory and have installed dependencies")
...
def setup():
    ...
    if hasattr(sys, 'real_prefix') or (hasattr(sys, 'base_prefix') and sys.base_prefix != sys.prefix):
        ...
        console.print("⚠️ No virtual environment detected. Consider using: python -m venv venv")
